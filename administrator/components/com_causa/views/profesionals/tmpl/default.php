...
$canOrder       = $user->authorise('core.edit.state', 'com_causa.profesional');
$saveOrder      = $listOrder == 'a.ordering';
?>
<form action="<?php echo JRoute::_('index.php?option=com_causa&view=profesionals'); ?>" method="post" name="adminForm">
	...
	foreach ($this->items as $i => $item) :	
		$canCreate      = $user->authorise('core.create','com_causa.profesional.'.$item->id);
        $link 		= JRoute::_( 'index.php?option=com_causa&task=profesional.edit&id='. $item->id );
		?>
