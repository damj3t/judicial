...
$canOrder       = $user->authorise('core.edit.state', 'com_causa.paciente');
$saveOrder      = $listOrder == 'a.ordering';
?>
<form action="<?php echo JRoute::_('index.php?option=com_causa&view=pacientes'); ?>" method="post" name="adminForm">
	...
	foreach ($this->items as $i => $item) :	
        ...
        $link 		= JRoute::_( 'index.php?option=com_causa&task=paciente.edit&id='. $item->id );
		?>
