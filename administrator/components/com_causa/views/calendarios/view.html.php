...
class CausaViewCalendarios extends JView
{
	protected $items;
        ...
        protected function addToolbar()
        {
                ...
                JToolBarHelper::title(JText::_( 'COM_TECNOMED_AGENDA_MANAGER' ), 'calendario' );
		...
		//if ($canDo->get('core.delete')) {
                        JToolBarHelper::deleteList('', 'calendario.delete','JTOOLBAR_DELETE');
		//}
