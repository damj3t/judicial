...
class CausaViewDiagnostico extends JView
{
	...
	protected function addToolbar()
		...
		JToolBarHelper::title(JText::_(($isNew ? 'COM_TECNOMED_PAGE_ADD_PACIENTE' : 'COM_TECNOMED_PAGE_VIEW_PACIENTE')), $icon);
             ...
             //           JToolBarHelper::apply('diagnostico.apply', 'JTOOLBAR_APPLY');
             //           JToolBarHelper::save('diagnostico.save', 'JTOOLBAR_SAVE');
             //   }

                if (empty($this->item->id))  {
              //          JToolBarHelper::cancel('diagnostico.cancel');
                } else {
               //         JToolBarHelper::cancel('diagnostico.cancel', 'JTOOLBAR_CLOSE');
                }
        }
		protected function setDocument() 
			{
				...
				$document->addScript(JURI::root() . "/administrator/components/com_causa/views/diagnostico/submitbutton.js");
