...
class CausaViewFarmaco extends JView
{
	...
	protected function addToolbar()
		...
		JToolBarHelper::title(JText::_(($isNew ? 'COM_TECNOMED_PAGE_ADD_PACIENTE' : 'COM_TECNOMED_PAGE_VIEW_PACIENTE')), $icon);
                ...
                if (!$checkedOut && $canDo->get('core.edit')) {
                        JToolBarHelper::apply('farmaco.apply', 'JTOOLBAR_APPLY');
                        JToolBarHelper::save('farmaco.save', 'JTOOLBAR_SAVE');
                }

                if (empty($this->item->id))  {
                        JToolBarHelper::cancel('farmaco.cancel');
                } else {
                        JToolBarHelper::cancel('farmaco.cancel', 'JTOOLBAR_CLOSE');
                }
        }
		protected function setDocument() 
			{
				...
				$document->addScript(JURI::root() . "/administrator/components/com_causa/views/farmaco/submitbutton.js");
