	...
	protected function getListQuery()
        {
                ...
                $query->from('`#__tm_diagnosticos` AS a');
	
			
		// Join over the users for the checked out user.
                $query->select('u.nombre AS grupo');
                $query->join('LEFT', '#__tm_grupodiagnostico AS u ON u.id=a.grupoid');
