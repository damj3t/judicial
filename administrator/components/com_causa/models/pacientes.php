...
class CausaModelPacientes extends JModelList
{
	...
	protected function getListQuery()
        {
                ...
                $query->from('`#__tm_pacientes` AS a');
	
			
		// Join over the users for the checked out user.
                $query->select('u.nombre AS isapre');
                $query->join('LEFT', '#__tm_isapres AS u ON u.id=a.isapreid');
