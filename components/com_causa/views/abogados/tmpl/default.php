...
//$canOrder       = $user->authorise('core.edit.state', 'com_causa.abogado');
//$saveOrder      = $listOrder == 'a.ordering';
?>
<form action="<?php echo JRoute::_('index.php?option=com_causa&view=abogados'); ?>" method="post" name="adminForm">
	...
	foreach ($this->items as $i => $item) :	
        ...
        $link 		= JRoute::_( 'index.php?option=com_causa&task=abogado.edit&id='. $item->id );
		?>
