...
class TecnomedViewCategory extends JView
{
	protected $state;
	protected $items;
	protected $category;
...
//--------------------------
		$path= null;
		$path[] = array('title' => $this->category->title, 'link' => TecnomedHelperRoute::getCategoryRoute($this->category->id));
		$category=$this->category->getParent();
		if ($category->id!="root"){
                        while($category->id > 1){
                                $path[] = array('title' => $category->title, 'link' => TecnomedHelperRoute::getCategoryRoute($category->id));
