...
class CausaModelAbogados extends JModelList
{
	...
	protected function getListQuery()
        {
                ...
                $query->from('`#__sico_abogados` AS a');
				$query->where('a.id_user is null');
			
		// Join over the users for the checked out user.
        //        $query->select('u.especialidad AS especialidad');
        //        $query->join('LEFT', '#__tm_especialidades AS u ON u.id=a.especialidad_id');
